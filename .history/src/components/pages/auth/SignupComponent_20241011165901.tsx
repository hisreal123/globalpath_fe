...
const SignupComponent = () => {
  ...
  return (
    <div>
      ...
      <div className="form_wrapper bg-white p-8 rounded-lg shadow-lg w-11/12 max-w-md mt-10 md:mt-40 mx-auto">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select
                      onValueChange={field.onChange} // Bind to React Hook Form's `onChange`
